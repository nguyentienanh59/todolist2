...
function checkPasswordError(password) {
  ...
  let isErrorRegex = !passwordRegex.test(password.value);
...
form.addEventListener("submit", function (e) {
  ...
  let isregexPasswordError = checkPasswordError(password);

  if (isEmptyError || isErrorPassword || isregexPasswordError) {
    alert("Nhập lại");
  } else {
